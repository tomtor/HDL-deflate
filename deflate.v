        ...
        case (state)
            ...
            5'b10000: begin
                if ((1'b1 && 1'b0)) begin
                    ...
                    offset <= (($signed({1'b0, do}) - distance) & 1023);
                    length <= tlength;
                    cur_i <= 0;
            ...
            5'b10101: begin
                if ((!1'b1)) begin
                ...
                else if (((cur_i == 0) && ((do + length) >= (i_raddr + 1024)))) begin
                    // pass
                end
                    ...
                    if ((cur_i > 1)) begin
                        if ((((offset + cur_i) & 1023) == ((do + 1) & 1023))) begin
                            obyte <= copy1;
                        end
                        else if (((cur_i == 3) || (((offset + cur_i) & 1023) != (do & 1023)))) begin
                            obyte <= orbyte;
                        end
