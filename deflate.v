                    ...
                    if (((cur_search >= 0) && (cur_search >= ($signed({1'b0, di}) - 32)) && ($signed({1'b0, di}) < ($signed({1'b0, isize}) - 3)))) begin
                        if (1'b1) begin
                            ...
                            if ((($signed({1'b0, di}) < ($signed({1'b0, isize}) - 4)) && (iram[((cur_search + 3) & 511)] == b4))) begin
                                ...
                                else if ((($signed({1'b0, di}) < ($signed({1'b0, isize}) - 5)) && (iram[((cur_search + 4) & 511)] == b5))) begin
                                    lencode = 259;
                                    match = 5;
                                    if (1'b1) begin
                                        if ((fcount < 10)) begin
                                        ...
                                        else if ((($signed({1'b0, di}) < ($signed({1'b0, isize}) - 6)) && (iram[((cur_search + 5) & 511)] == b6))) begin
                                            lencode = 260;
                                            match = 6;
