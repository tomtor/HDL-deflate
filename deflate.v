        ...
        case (state)
            ...
            5'b10111: begin
                if ((!1'b0)) begin
                    ...
                    if (((cur_search >= 0) && (cur_search >= ($signed({1'b0, di}) - 256)) && ($signed({1'b0, di}) < ($signed({1'b0, isize}) - 3)))) begin
                        if (1'b0) begin
                            found = 0;
                            fmatch = 0;
                            begin: MYHDL19_BREAK
                            ...
                            if (((!1'b0) && (iram[(cur_search & 511)] == b1) && (iram[((cur_search + 1) & 511)] == b2) && (iram[((cur_search + 2) & 511)] == b3))) begin
                                more <= 4;
                                state <= 5'b11000;
                            end
                            else begin
            ...
            5'b10000: begin
                if ((1'b1 && 1'b1)) begin
                    ...
                    offset <= (($signed({1'b0, do}) - distance) & 8191);
                    length <= tlength;
                    cur_i <= 0;
            ...
            5'b10101: begin
                if ((!1'b1)) begin
                ...
                else if (((cur_i == 0) && ((do + length) >= (i_raddr + 8192)))) begin
                    // pass
                end
                    ...
                    if ((cur_i > 1)) begin
                        if ((((offset + cur_i) & 8191) == ((do + 1) & 8191))) begin
                            obyte <= copy1;
                        end
                        else if (((cur_i == 3) || (((offset + cur_i) & 8191) != (do & 8191)))) begin
                            obyte <= orbyte;
                        end
