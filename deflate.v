    ...
    if ((!reset)) begin
        ...
        case (state)
            ...
            5'b00111: begin
                ...
                if (((method != 4) && (cur_HF1 < 4096))) begin
                    leaves[cur_HF1] <= 0;
                end
                limit = 4096;
                if ((method == 4)) begin
            ...
            5'b10011: begin
                ...
                else if ((MYHDL57_get_bits(leaf) >= cur_next)) begin
                    $write("CACHE MISS");
                    $write("\n");
            ...
            5'b10101: begin
                if ((!1'b1)) begin
                    ...
                    if ((cur_i > 1)) begin
                        if ((((offset + cur_i) & 65535) == ((do + 1) & 65535))) begin
                            obyte <= copy1;
                        end
                        else if (((cur_i == 3) || (((offset + cur_i) & 65535) != (do & 65535)))) begin
                            obyte <= orbyte;
                        end
