                    ...
                    if (((cur_search >= 0) && (cur_search >= ($signed({1'b0, di}) - 32)) && ($signed({1'b0, di}) < ($signed({1'b0, isize}) - 3)))) begin
                        ...
                        if (1'b1) begin
                            ...
                            if (((!found) || ((($signed({1'b0, di}) - fmatch) - 1) < 0))) begin
                                ...
                                distance = (fmatch + 1);
                                fmatch = (($signed({1'b0, di}) - fmatch) + 3);
                                lencode = 257;
                                match = 3;
                                if ((($signed({1'b0, di}) < ($signed({1'b0, isize}) - 4)) && (iram[(fmatch & 127)] == b4))) begin
                                    lencode = 258;
                                    match = 4;
                                    if ((($signed({1'b0, di}) < ($signed({1'b0, isize}) - 5)) && (iram[(fmatch & 127)] == iram[((di + 4) & 127)]))) begin
                                        lencode = 259;
                                        match = 5;
                                        if ((1'b0 && ($signed({1'b0, di}) < ($signed({1'b0, isize}) - 6)) && (iram[(fmatch & 127)] == iram[((di + 5) & 127)]))) begin
                                            lencode = 260;
                                            match = 6;
                                            if ((($signed({1'b0, di}) < ($signed({1'b0, isize}) - 7)) && (iram[(fmatch & 127)] == iram[((di + 6) & 127)]))) begin
                                                lencode = 261;
                                                match = 7;
                                                if ((($signed({1'b0, di}) < ($signed({1'b0, isize}) - 8)) && (iram[(fmatch & 127)] == iram[((di + 7) & 127)]))) begin
                                                    lencode = 262;
                                                    match = 8;
                                                    if ((($signed({1'b0, di}) < ($signed({1'b0, isize}) - 9)) && (iram[(fmatch & 127)] == iram[((di + 8) & 127)]))) begin
                                                        lencode = 263;
                                                        match = 9;
                                                        if ((($signed({1'b0, di}) < ($signed({1'b0, isize}) - 10)) && (iram[(fmatch & 127)] == iram[((di + 9) & 127)]))) begin
                                                            lencode = 264;
                                                            match = 10;
                                                        end
                                                    end
                            ...
                            if ((($signed({1'b0, di}) < ($signed({1'b0, isize}) - 4)) && (iram[((cur_search + 3) & 127)] == b4))) begin
                                ...
                                if ((($signed({1'b0, di}) < ($signed({1'b0, isize}) - 5)) && (iram[((cur_search + 4) & 127)] == iram[((di + 4) & 127)]))) begin
                                    lencode = 259;
                                    match = 5;
                                    if ((1'b0 && ($signed({1'b0, di}) < ($signed({1'b0, isize}) - 6)) && (iram[((cur_search + 5) & 127)] == iram[((di + 5) & 127)]))) begin
                                        lencode = 260;
                                        match = 6;
...
assign smatch[0] = (((cwindow >>> 0) & 16777215) == (b14 >>> 8));



assign smatch[1] = (((cwindow >>> 1) & 16777215) == (b14 >>> 8));



assign smatch[2] = (((cwindow >>> 2) & 16777215) == (b14 >>> 8));



assign smatch[3] = (((cwindow >>> 3) & 16777215) == (b14 >>> 8));



assign smatch[4] = (((cwindow >>> 4) & 16777215) == (b14 >>> 8));



assign smatch[5] = (((cwindow >>> 5) & 16777215) == (b14 >>> 8));



assign smatch[6] = (((cwindow >>> 6) & 16777215) == (b14 >>> 8));



assign smatch[7] = (((cwindow >>> 7) & 16777215) == (b14 >>> 8));



assign smatch[8] = (((cwindow >>> 8) & 16777215) == (b14 >>> 8));



assign smatch[9] = (((cwindow >>> 9) & 16777215) == (b14 >>> 8));



assign smatch[10] = (((cwindow >>> 10) & 16777215) == (b14 >>> 8));



assign smatch[11] = (((cwindow >>> 11) & 16777215) == (b14 >>> 8));



assign smatch[12] = (((cwindow >>> 12) & 16777215) == (b14 >>> 8));



assign smatch[13] = (((cwindow >>> 13) & 16777215) == (b14 >>> 8));



assign smatch[14] = (((cwindow >>> 14) & 16777215) == (b14 >>> 8));



assign smatch[15] = (((cwindow >>> 15) & 16777215) == (b14 >>> 8));



assign smatch[16] = (((cwindow >>> 16) & 16777215) == (b14 >>> 8));



assign smatch[17] = (((cwindow >>> 17) & 16777215) == (b14 >>> 8));



assign smatch[18] = (((cwindow >>> 18) & 16777215) == (b14 >>> 8));



assign smatch[19] = (((cwindow >>> 19) & 16777215) == (b14 >>> 8));



assign smatch[20] = (((cwindow >>> 20) & 16777215) == (b14 >>> 8));



assign smatch[21] = (((cwindow >>> 21) & 16777215) == (b14 >>> 8));



assign smatch[22] = (((cwindow >>> 22) & 16777215) == (b14 >>> 8));



assign smatch[23] = (((cwindow >>> 23) & 16777215) == (b14 >>> 8));



assign smatch[24] = (((cwindow >>> 24) & 16777215) == (b14 >>> 8));



assign smatch[25] = (((cwindow >>> 25) & 16777215) == (b14 >>> 8));



assign smatch[26] = (((cwindow >>> 26) & 16777215) == (b14 >>> 8));



assign smatch[27] = (((cwindow >>> 27) & 16777215) == (b14 >>> 8));



assign smatch[28] = (((cwindow >>> 28) & 16777215) == (b14 >>> 8));



assign smatch[29] = (((cwindow >>> 29) & 16777215) == (b14 >>> 8));



assign smatch[30] = (((cwindow >>> 30) & 16777215) == (b14 >>> 8));



assign smatch[31] = (((cwindow >>> 31) & 16777215) == (b14 >>> 8));
