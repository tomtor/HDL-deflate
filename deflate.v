        ...
        case (state)
            ...
            5'b10000: begin
                if (1'b1) begin
                    ...
                    if (((distance >= 16383) && (65536 != 65536))) begin
                        $write("%0d", distance);
                        $write("\n");
                        $finish;
                    end
                    ...
                    offset <= (($signed({1'b0, do}) - distance) & 65535);
                    length <= tlength;
                    cur_i <= 0;
            ...
            5'b10100: begin
                ...
                else if (($signed({1'b0, do}) >= ((i_raddr + 65536) - 4))) begin
                    $write("HOLDB");
                    $write("\n");
                    // pass
                end
            ...
            5'b10101: begin
                ...
                else if (((cur_i == 0) && (do >= (i_raddr + 16383)))) begin
                    // pass
                end
