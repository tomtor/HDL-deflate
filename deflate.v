...
begin: MYHDL84_RETURN
    ...
    MYHDL5_get4 = ((((((b4 << 24) | (b3 << 16)) | (b2 << 8)) | b1) >>> (dio + boffset)) & ((1 << width) - 1));
...
begin: MYHDL85_RETURN
    ...
    MYHDL6_get4 = ((((((b4 << 24) | (b3 << 16)) | (b2 << 8)) | b1) >>> (dio + boffset)) & ((1 << width) - 1));
...
begin: MYHDL88_RETURN
    ...
    MYHDL9_get4 = ($signed(((((b4 << 24) | (b3 << 16)) | (b2 << 8)) | b1) >>> ($signed({1'b0, dio}) + boffset)) & ((1 << width) - 1));
...
begin: MYHDL105_RETURN
    ...
    MYHDL34_get4 = ((((((b4 << 24) | (b3 << 16)) | (b2 << 8)) | b1) >>> (dio + boffset)) & ((1 << width) - 1));
...
begin: MYHDL106_RETURN
    ...
    MYHDL35_get4 = ((((((b4 << 24) | (b3 << 16)) | (b2 << 8)) | b1) >>> (dio + boffset)) & ((1 << width) - 1));
...
begin: MYHDL107_RETURN
    ...
    MYHDL36_get4 = ((((((b4 << 24) | (b3 << 16)) | (b2 << 8)) | b1) >>> (dio + boffset)) & ((1 << width) - 1));
...
begin: MYHDL108_RETURN
    ...
    MYHDL37_get4 = ((((((b4 << 24) | (b3 << 16)) | (b2 << 8)) | b1) >>> (dio + boffset)) & ((1 << width) - 1));
...
begin: MYHDL109_RETURN
    ...
    MYHDL38_get4 = ((((((b4 << 24) | (b3 << 16)) | (b2 << 8)) | b1) >>> (dio + boffset)) & ((1 << width) - 1));
...
begin: MYHDL110_RETURN
    ...
    MYHDL39_get4 = ((((((b4 << 24) | (b3 << 16)) | (b2 << 8)) | b1) >>> (dio + boffset)) & ((1 << width) - 1));
...
begin: MYHDL112_RETURN
    ...
    MYHDL41_get4 = ((((((b4 << 24) | (b3 << 16)) | (b2 << 8)) | b1) >>> (dio + boffset)) & ((1 << width) - 1));
...
begin: MYHDL114_RETURN
    ...
    MYHDL43_get4 = ((((((b4 << 24) | (b3 << 16)) | (b2 << 8)) | b1) >>> (dio + boffset)) & ((1 << width) - 1));
...
begin: MYHDL115_RETURN
    ...
    MYHDL44_get4 = ((((((b4 << 24) | (b3 << 16)) | (b2 << 8)) | b1) >>> (dio + boffset)) & ((1 << width) - 1));
...
begin: MYHDL116_RETURN
    ...
    MYHDL45_get4 = ((((((b4 << 24) | (b3 << 16)) | (b2 << 8)) | b1) >>> (dio + boffset)) & ((1 << width) - 1));
...
begin: MYHDL122_RETURN
    ...
    MYHDL57_get4 = ((((((b4 << 24) | (b3 << 16)) | (b2 << 8)) | b1) >>> (dio + boffset)) & ((1 << width) - 1));
...
begin: MYHDL129_RETURN
    ...
    MYHDL64_get4 = ($signed(((((b4 << 24) | (b3 << 16)) | (b2 << 8)) | b1) >>> ($signed({1'b0, dio}) + boffset)) & ((1 << width) - 1));
...
begin: MYHDL132_RETURN
    ...
    MYHDL67_get4 = ((((((b4 << 24) | (b3 << 16)) | (b2 << 8)) | b1) >>> (dio + boffset)) & ((1 << width) - 1));
...
begin: MYHDL135_RETURN
    ...
    MYHDL70_get4 = ($signed(((((b4 << 24) | (b3 << 16)) | (b2 << 8)) | b1) >>> ($signed({1'b0, dio}) + boffset)) & ((1 << width) - 1));
...
begin: MYHDL138_RETURN
    ...
    MYHDL73_get4 = ((((((b4 << 24) | (b3 << 16)) | (b2 << 8)) | b1) >>> (dio + boffset)) & ((1 << width) - 1));
...
begin: MYHDL139_RETURN
    ...
    MYHDL74_get4 = ($signed(((((b4 << 24) | (b3 << 16)) | (b2 << 8)) | b1) >>> ($signed({1'b0, dio}) + boffset)) & ((1 << width) - 1));
...
begin: MYHDL141_RETURN
    ...
    MYHDL76_get4 = ($signed(((((b4 << 24) | (b3 << 16)) | (b2 << 8)) | b1) >>> ($signed({1'b0, dio}) + boffset)) & ((1 << width) - 1));
                ...
                5'b10100: begin
                    if ((!filled)) begin
                        ...
                        if (((cur_search >= 0) && (cur_search >= ($signed({1'b0, di}) - 32)) && (di >= 3) && ($signed({1'b0, di}) < ($signed({1'b0, isize}) - 3)))) begin
                            if (((iram[cur_search] == b1) && (iram[(cur_search + 1)] == b2) && (iram[(cur_search + 2)] == b3))) begin
                                lencode = 257;
                                match = 3;
                                if ((($signed({1'b0, di}) < ($signed({1'b0, isize}) - 4)) && (iram[(cur_search + 3)] == iram[(di + 3)]))) begin
                                    lencode = 258;
                                    match = 4;
                                    if ((($signed({1'b0, di}) < ($signed({1'b0, isize}) - 5)) && (iram[(cur_search + 4)] == iram[(di + 4)]))) begin
                                        lencode = 259;
                                        match = 5;
                                        if ((($signed({1'b0, di}) < ($signed({1'b0, isize}) - 6)) && (iram[(cur_search + 5)] == iram[(di + 5)]))) begin
                                            lencode = 260;
                                            match = 6;
                                            if ((($signed({1'b0, di}) < ($signed({1'b0, isize}) - 7)) && (iram[(cur_search + 6)] == iram[(di + 6)]))) begin
                                                lencode = 261;
                                                match = 7;
                                                if ((($signed({1'b0, di}) < ($signed({1'b0, isize}) - 8)) && (iram[(cur_search + 7)] == iram[(di + 7)]))) begin
                                                    lencode = 262;
                                                    match = 8;
                                                    if ((($signed({1'b0, di}) < ($signed({1'b0, isize}) - 9)) && (iram[(cur_search + 8)] == iram[(di + 8)]))) begin
                                                        lencode = 263;
                                                        match = 9;
                                                        if ((($signed({1'b0, di}) < ($signed({1'b0, isize}) - 10)) && (iram[(cur_search + 9)] == iram[(di + 9)]))) begin
                                                            lencode = 264;
                                                            match = 10;
                                                        end
                                                    end
