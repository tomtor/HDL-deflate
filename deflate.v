...
begin: MYHDL97_RETURN
    ...
    MYHDL26_get4 = ((b41 >>> (dio + boffset)) & ((1 << width) - 1));
    disable MYHDL97_RETURN;
end
endfunction

function integer MYHDL27_get4;
    input boffset;
    input width;
    integer width;
begin: MYHDL98_RETURN
    ...
    MYHDL27_get4 = ((b41 >>> (dio + boffset)) & ((1 << width) - 1));
    disable MYHDL98_RETURN;
end
endfunction

function integer MYHDL28_get4;
    input boffset;
    integer boffset;
    input width;
    integer width;
begin: MYHDL99_RETURN
    ...
    MYHDL28_get4 = ((b41 >>> (dio + boffset)) & ((1 << width) - 1));
    disable MYHDL99_RETURN;
end
endfunction

function integer MYHDL29_get4;
    input boffset;
    integer boffset;
    input width;
    integer width;
begin: MYHDL100_RETURN
    ...
    MYHDL29_get4 = ((b41 >>> (dio + boffset)) & ((1 << width) - 1));
...
function integer MYHDL45_rev_bits;
    input [15-1:0] b;
    input [4-1:0] nb;
    integer r;
...
function integer MYHDL46_makeLeaf;
    input [9-1:0] lcode;
    input [4-1:0] lbits;
begin: MYHDL111_RETURN
    ...
    MYHDL46_makeLeaf = ((lcode << 9) | lbits);
    disable MYHDL111_RETURN;
end
endfunction

function integer MYHDL47_makeLeaf;
    input [9-1:0] lcode;
    input [4-1:0] lbits;
begin: MYHDL112_RETURN
    ...
    MYHDL47_makeLeaf = ((lcode << 9) | lbits);
    disable MYHDL112_RETURN;
end
endfunction

function integer MYHDL48_makeLeaf;
    input [9-1:0] lcode;
    input [4-1:0] lbits;
begin: MYHDL113_RETURN
    ...
    MYHDL48_makeLeaf = ((lcode << 9) | lbits);
    disable MYHDL113_RETURN;
end
endfunction

function integer MYHDL49_get4;
    input boffset;
    input [5-1:0] width;
begin: MYHDL114_RETURN
    ...
    MYHDL49_get4 = ((b41 >>> (dio + boffset)) & ((1 << width) - 1));
    disable MYHDL114_RETURN;
end
endfunction

function integer MYHDL50_get_bits;
    input [24-1:0] aleaf;
begin: MYHDL115_RETURN
    MYHDL50_get_bits = ($signed({1'b0, aleaf}) & ((1 << 9) - 1));
    disable MYHDL115_RETURN;
end
endfunction

function integer MYHDL51_get_bits;
    input [24-1:0] aleaf;
begin: MYHDL116_RETURN
    MYHDL51_get_bits = ($signed({1'b0, aleaf}) & ((1 << 9) - 1));
    disable MYHDL116_RETURN;
end
endfunction

function integer MYHDL52_get_bits;
    input [24-1:0] aleaf;
begin: MYHDL117_RETURN
    MYHDL52_get_bits = ($signed({1'b0, aleaf}) & ((1 << 9) - 1));
...
function integer MYHDL54_get_code;
    input [24-1:0] aleaf;
begin: MYHDL119_RETURN
    MYHDL54_get_code = (aleaf >>> 9);
    disable MYHDL119_RETURN;
end
endfunction

function integer MYHDL55_get_code;
    input [24-1:0] aleaf;
begin: MYHDL120_RETURN
    MYHDL55_get_code = (aleaf >>> 9);
...
begin: MYHDL121_RETURN
    ...
    MYHDL56_get4 = ($signed($signed({1'b0, b41}) >>> ($signed({1'b0, dio}) + boffset)) & ((1 << width) - 1));
...
begin: MYHDL124_RETURN
    ...
    MYHDL59_get4 = ((b41 >>> (dio + boffset)) & ((1 << width) - 1));
...
begin: MYHDL131_RETURN
    ...
    MYHDL66_get4 = ($signed($signed({1'b0, b41}) >>> ($signed({1'b0, dio}) + boffset)) & ((1 << width) - 1));
    disable MYHDL131_RETURN;
end
endfunction

function integer MYHDL67_rev_bits;
    input b;
    integer b;
    input nb;
    integer nb;
            ...
            case (state)
                ...
                default: begin
                    if ((state == 5'b01100)) begin
                        ...
                        if ((cur_static < 288)) begin
                            if ((cur_static < 144)) begin
                                codeLength[cur_static] <= 8;
                            end
                            else if ((cur_static < 256)) begin
                                codeLength[cur_static] <= 9;
                            end
                            else if ((cur_static < 280)) begin
                                codeLength[cur_static] <= 7;
                            end
                            else begin
                                codeLength[cur_static] <= 8;
                            end
                            cur_static <= (cur_static + 1);
                        end
                        else begin
                            numCodeLength <= 288;
                            cur_HF1 <= 0;
                        ...
                        case (state)
                            5'b00010: begin
                                if ((!filled)) begin
                                    ...
                                    numLiterals <= (257 + MYHDL26_get4(0, 5));
                                    $write("NL:");
                                    $write(" ");
                                    $write("%0d", (257 + MYHDL27_get4(0, 5)));
                                    $write("\n");
                                    numDistance <= (1 + MYHDL28_get4(5, 5));
                                    $write("ND:");
                                    $write(" ");
                                    $write("%0d", (1 + MYHDL29_get4(5, 5)));
                                    $write("\n");
                                    b_numCodeLength <= (4 + MYHDL30_get4(10, 4));
                                    $write("NCL:");
                                    $write(" ");
                                    $write("%0d", (4 + MYHDL31_get4(10, 4)));
                                    $write("\n");
                                    numCodeLength <= 0;
                                    MYHDL32_adv(14);
                                end
                            ...
                            5'b00011: begin
                                if ((!filled)) begin
                                    ...
                                    if ((code < 16)) begin
                                        ...
                                        howOften <= (3 + MYHDL35_get4(0, 2));
                                        i = 2;
                                    end
                                    else if ((code == 17)) begin
                                        howOften <= (3 + MYHDL36_get4(0, 3));
                                        lastToken <= 0;
                                        i = 3;
                                    end
                                    else if ((code == 18)) begin
                                        howOften <= (11 + MYHDL37_get4(0, 7));
                                        lastToken <= 0;
                                        i = 7;
                                    end
                                    else begin
                            ...
                            default: begin
                                if ((state == 5'b00110)) begin
                                    ...
                                    case (state)
                                            ...
                                            if ((spread_i < numCodeLength)) begin
                                                ...
                                                if ((bits != 0)) begin
                                                    if ((HF4_init == 0)) begin
                                                        ...
                                                        reverse <= MYHDL45_rev_bits(canonical, bits);
                                                        leaf <= MYHDL46_makeLeaf(spread_i, bits);
                                                        HF4_init <= 1;
                                                    end
                                        ...
                                        5'b01111: begin
                                            if ((method == 4)) begin
                                                d_leaves[spread] <= MYHDL47_makeLeaf(spread_i, codeLength[spread_i]);
                                            end
                                            else begin
                                                leaves[spread] <= MYHDL48_makeLeaf(spread_i, codeLength[spread_i]);
                                            end
                                            aim = instantMask;
                                            if ((method == 4)) begin
                                                aim = d_instantMask;
                                        ...
                                        5'b10000: begin
                                            if ((!filled)) begin
                                                ...
                                                if ((MYHDL50_get_bits(leaf) <= cur_next)) begin
                                                    if ((MYHDL51_get_bits(leaf) < 1)) begin
                                                        $write("< 1 bits: ");
                                                        $write("\n");
                                                        $finish;
                                                    end
                                                    MYHDL53_adv(MYHDL52_get_bits(leaf));
                                                    if ((MYHDL54_get_code(leaf) == 0)) begin
                                                        $write("leaf 0");
                                                        $write("\n");
                                                    end
                                                    code <= MYHDL55_get_code(leaf);
                                                    if ((method == 2)) begin
                                                        state <= 5'b00011;
                                                    end
                                                    else begin
                                        ...
                                        5'b01101: begin
                                            if ((!filled)) begin
                                                ...
                                                if ((d_instantMaxBit <= d_maxBits)) begin
                                                    ...
                                                    endcase
                                                    cto = MYHDL56_get4(extraLength, d_maxBits);
                                                ...
                                                if ((MYHDL57_get_bits(leaf) <= cur_next)) begin
                                                    if ((MYHDL58_get_bits(leaf) == 0)) begin
                                                        $finish;
                                                    end
                                                    token = (code - 257);
                                                    case (token)
                                                    ...
                                                    case (token)
                                                        ...
                                                        default: extraLength = 0;
                                                    endcase
                                                    tlength = tlength + MYHDL59_get4(0, extraLength);
                                                    distanceCode = MYHDL60_get_code(leaf);
                                                    case (distanceCode)
                                                        0: distance = 1;
                                                        1: distance = 2;
                                                        2: distance = 3;
                                                    ...
                                                    case ($signed(distanceCode >>> 1))
                                                        ...
                                                        default: moreBits = 13;
                                                    endcase
                                                    mored = MYHDL62_get4((extraLength + MYHDL61_get_bits(leaf)), moreBits);
                                                    distance = distance + mored;
                                                    MYHDL64_adv(((moreBits + extraLength) + MYHDL63_get_bits(leaf)));
                                                ...
                                                if ((!filled)) begin
                                                    ...
                                                    if ((code < 256)) begin
                                                        ...
                                                        if (static) begin
                                                            ...
                                                            t = MYHDL66_get4(extraLength, 5);
                                                            distanceCode = MYHDL67_rev_bits(t, 5);
                                                            case (distanceCode)
                                                                0: distance = 1;
                                                                1: distance = 2;
                                                                2: distance = 3;
                                                            ...
                                                            case ($signed(distanceCode >>> 1))
                                                                ...
                                                                default: moreBits = 13;
                                                            endcase
                                                            distance = distance + MYHDL68_get4((extraLength + 5), moreBits);
                                                            MYHDL69_adv(((extraLength + 5) + moreBits));
                                                            offset <= ($signed({1'b0, do}) - distance);
                                                            length <= tlength;
                                                            cur_i <= 0;
                                                            state <= 5'b10010;
