...
always @(posedge clk) begin: DEFLATE_LOGIC
    ...
    if ((!reset)) begin
        ...
        case (state)
            ...
            5'b11000: begin
                if ((1'b0 && (more != 6) && (more > fcount))) begin
                    $write("SEARCH10");
                    $write(" ");
                    $write("%h", more);
                    $write(" ");
            ...
            5'b10101: begin
                if ((!1'b1)) begin
                    ...
                    oraddr <= (offset + cur_i);
                    if ((cur_i == 1)) begin
                        off1 <= ($signed({1'b0, offset}) == (($signed({1'b0, do}) - 1) & 1023));
                        off2 <= ($signed({1'b0, offset}) == (($signed({1'b0, do}) - 2) & 1023));
                        copy1 <= orbyte;
                    end
                    if ((cur_i == 3)) begin
                        copy2 <= orbyte;
