                ...
                if ((state == 5'b11000)) begin
                    ...
                    case (state)
                        ...
                        5'b10101: begin
                            if ((!1'b1)) begin
                            ...
                            else if (((copy_i == 0) && ((do + length) >= (i_raddr + 512)))) begin
                                // pass
                            end
                            ...
                            else if ((copy_i < (length + 2))) begin
                                oraddr <= (offset + copy_i);
                                if ((copy_i == 1)) begin
                                ...
                                if ((copy_i > 1)) begin
                                    ...
                                    else if (((copy_i == 3) || (!off2))) begin
                                        obyte <= orbyte;
                                    end
                                    else if ((copy_i > 2)) begin
                                        if ((copy_i & 1)) begin
                                            obyte <= copy2;
                                        end
                                        else begin
