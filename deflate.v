            ...
            5'b10111: begin
                if ((!1'b1)) begin
                    ...
                    if (((cur_search >= 0) && (cur_search >= ($signed({1'b0, di}) - 32)) && ($signed({1'b0, di}) < ($signed({1'b0, isize}) - 3)))) begin
                        if (1'b0) begin
                        ...
                        else if (((!1'b0) && (iram[(cur_search & 511)] == b1) && (iram[((cur_search + 1) & 511)] == b2) && (iram[((cur_search + 2) & 511)] == b3))) begin
                            lencode = 257;
                            match = 3;
                            mdone = 1'b1;
                            if ((($signed({1'b0, di}) < ($signed({1'b0, isize}) - 4)) && (iram[((cur_search + 3) & 511)] == b4))) begin
                                ...
                                if ((fcount < 5)) begin
                                    ...
                                    lencode = 259;
                                    match = 5;
                                    if ((1'b0 && ($signed({1'b0, di}) < ($signed({1'b0, isize}) - 6)) && (iram[((cur_search + 5) & 511)] == b6))) begin
                                        lencode = 260;
                                        match = 6;
