...
function integer MYHDL42_get4;
    ...
    input width;
    integer width;
begin: MYHDL176_RETURN
    MYHDL42_get4 = ((b41 >>> (dio + boffset)) & ((1 << width) - 1));
    disable MYHDL176_RETURN;
end
endfunction
...
function integer MYHDL43_get4;
    ...
    input width;
    integer width;
begin: MYHDL177_RETURN
    MYHDL43_get4 = ((b41 >>> (dio + boffset)) & ((1 << width) - 1));
    disable MYHDL177_RETURN;
end
endfunction
...
function integer MYHDL44_get4;
    ...
    input width;
    integer width;
begin: MYHDL178_RETURN
    MYHDL44_get4 = ((b41 >>> (dio + boffset)) & ((1 << width) - 1));
    disable MYHDL178_RETURN;
end
endfunction
...
function integer MYHDL62_get_code;
    input [19-1:0] aleaf;
begin: MYHDL190_RETURN
    MYHDL62_get_code = (aleaf >>> 4);
    disable MYHDL190_RETURN;
end
endfunction
...
function integer MYHDL73_get4;
    ...
    input width;
    integer width;
begin: MYHDL201_RETURN
    MYHDL73_get4 = ((b41 >>> (dio + boffset)) & ((1 << width) - 1));
    disable MYHDL201_RETURN;
end
endfunction
        ...
        case (state)
            ...
            5'b11000: begin
                if ((1'b1 && 1'b1)) begin
                    ...
                    match = 3;
                    mdone = 1'b1;
                    if ((($signed({1'b0, di}) < ($signed({1'b0, isize}) - 4)) && (iram[(fmatch2 & 1023)] == b4))) begin
                        lencode = 258;
                        match = 4;
                        if ((($signed({1'b0, di}) < ($signed({1'b0, isize}) - 5)) && (iram[((fmatch2 + 1) & 1023)] == b5))) begin
                            lencode = 259;
                            match = 5;
                            if (1'b1) begin
                                if ((fcount < 6)) begin
                                    ...
                                    if ((($signed({1'b0, di}) < ($signed({1'b0, isize}) - 6)) && (iram[((fmatch2 + 2) & 1023)] == b6))) begin
                                        lencode = 260;
                                        match = 6;
                                        if ((fcount < 7)) begin
                                            mdone = 1'b0;
                                        ...
                                        else if ((($signed({1'b0, di}) < ($signed({1'b0, isize}) - 7)) && (iram[((fmatch2 + 3) & 1023)] == b7))) begin
                                            lencode = 261;
                                            match = 7;
                                            if ((fcount < 8)) begin
                                                mdone = 1'b0;
                                            ...
                                            else if ((($signed({1'b0, di}) < ($signed({1'b0, isize}) - 8)) && (iram[((fmatch2 + 4) & 1023)] == b8))) begin
                                                lencode = 262;
                                                match = 8;
                                                if ((fcount < 9)) begin
                                                    mdone = 1'b0;
                                                ...
                                                else if ((($signed({1'b0, di}) < ($signed({1'b0, isize}) - 9)) && (iram[((fmatch2 + 5) & 1023)] == b9))) begin
                                                    lencode = 263;
                                                    match = 9;
                                                    if ((fcount < 10)) begin
                                                        mdone = 1'b0;
                                                    ...
                                                    else if ((($signed({1'b0, di}) < ($signed({1'b0, isize}) - 10)) && (iram[((fmatch2 + 6) & 1023)] == b10))) begin
                                                        lencode = 264;
                                                        match = 10;
                                                    end
                                                end
            ...
            5'b10111: begin
                if ((!1'b1)) begin
                    ...
                    if (((cur_search >= 0) && (cur_search >= ($signed({1'b0, di}) - 64)) && ($signed({1'b0, di}) < ($signed({1'b0, isize}) - 3)))) begin
                        if (1'b1) begin
                            found = 0;
                            fmatch = 0;
                            begin: MYHDL21_BREAK
                        ...
                        else if (((!1'b1) && (iram[(cur_search & 1023)] == b1) && (iram[((cur_search + 1) & 1023)] == b2) && (iram[((cur_search + 2) & 1023)] == b3))) begin
                            lencode = 257;
                            match = 3;
                            if ((($signed({1'b0, di}) < ($signed({1'b0, isize}) - 4)) && (iram[((cur_search + 3) & 1023)] == b4))) begin
                                lencode = 258;
                                match = 4;
                                if ((($signed({1'b0, di}) < ($signed({1'b0, isize}) - 5)) && (iram[((cur_search + 4) & 1023)] == b5))) begin
                                    lencode = 259;
                                    match = 5;
                                    if ((1'b1 && ($signed({1'b0, di}) < ($signed({1'b0, isize}) - 6)) && (iram[((cur_search + 5) & 1023)] == b6))) begin
                                        lencode = 260;
                                        match = 6;
                                        if ((($signed({1'b0, di}) < ($signed({1'b0, isize}) - 7)) && (iram[((cur_search + 6) & 1023)] == b7))) begin
                                            lencode = 261;
                                            match = 7;
                                            if ((($signed({1'b0, di}) < ($signed({1'b0, isize}) - 8)) && (iram[((cur_search + 7) & 1023)] == b8))) begin
                                                lencode = 262;
                                                match = 8;
                                                if ((($signed({1'b0, di}) < ($signed({1'b0, isize}) - 9)) && (iram[((cur_search + 8) & 1023)] == b9))) begin
                                                    lencode = 263;
                                                    match = 9;
                                                    if ((($signed({1'b0, di}) < ($signed({1'b0, isize}) - 10)) && (iram[((cur_search + 9) & 1023)] == b10))) begin
                                                        lencode = 264;
                                                        match = 10;
                                                    end
                                                end
            ...
            5'b10010: begin
                if (1'b1) begin
                    if (((method == 4) && 1'b1)) begin
                        dlwaddr <= spread;
                        dwleaf <= MYHDL54_makeLeaf(spread_i, codeLength[spread_i]);
                    end
                    else begin
                        lwaddr <= spread;
            ...
            5'b01111: begin
                ...
                else if ((MYHDL64_get_bits(drleaf) >= cur_next)) begin
                    $write("DCACHE MISS");
                    $write(" ");
                    $write("%h", cur_next);
                    $write("\n");
            ...
            5'b10000: begin
                if ((1'b1 && 1'b1)) begin
                    if ((MYHDL66_get_bits(drleaf) == 0)) begin
                        $finish;
                    end
                    token = (code - 257);
                    case (token)
                    ...
                    distanceCode = MYHDL68_get_code(drleaf);
                    case (distanceCode)
                        0: distance = 1;
                        1: distance = 2;
                        2: distance = 3;
                    ...
                    case ($signed(distanceCode >>> 1))
                        ...
                        default: moreBits = 13;
                    endcase
                    mored = MYHDL70_get4((extraLength + MYHDL69_get_bits(drleaf)), moreBits);
                    ...
                    MYHDL72_adv(((moreBits + extraLength) + MYHDL71_get_bits(drleaf)));
...
assign smatch[32] = ((({cwindow, b1, b2} >>> (8 * 32)) & 16777215) == (b14 >>> 8));



assign smatch[33] = ((({cwindow, b1, b2} >>> (8 * 33)) & 16777215) == (b14 >>> 8));



assign smatch[34] = ((({cwindow, b1, b2} >>> (8 * 34)) & 16777215) == (b14 >>> 8));



assign smatch[35] = ((({cwindow, b1, b2} >>> (8 * 35)) & 16777215) == (b14 >>> 8));



assign smatch[36] = ((({cwindow, b1, b2} >>> (8 * 36)) & 16777215) == (b14 >>> 8));



assign smatch[37] = ((({cwindow, b1, b2} >>> (8 * 37)) & 16777215) == (b14 >>> 8));



assign smatch[38] = ((({cwindow, b1, b2} >>> (8 * 38)) & 16777215) == (b14 >>> 8));



assign smatch[39] = ((({cwindow, b1, b2} >>> (8 * 39)) & 16777215) == (b14 >>> 8));



assign smatch[40] = ((({cwindow, b1, b2} >>> (8 * 40)) & 16777215) == (b14 >>> 8));



assign smatch[41] = ((({cwindow, b1, b2} >>> (8 * 41)) & 16777215) == (b14 >>> 8));



assign smatch[42] = ((({cwindow, b1, b2} >>> (8 * 42)) & 16777215) == (b14 >>> 8));



assign smatch[43] = ((({cwindow, b1, b2} >>> (8 * 43)) & 16777215) == (b14 >>> 8));



assign smatch[44] = ((({cwindow, b1, b2} >>> (8 * 44)) & 16777215) == (b14 >>> 8));



assign smatch[45] = ((({cwindow, b1, b2} >>> (8 * 45)) & 16777215) == (b14 >>> 8));



assign smatch[46] = ((({cwindow, b1, b2} >>> (8 * 46)) & 16777215) == (b14 >>> 8));



assign smatch[47] = ((({cwindow, b1, b2} >>> (8 * 47)) & 16777215) == (b14 >>> 8));



assign smatch[48] = ((({cwindow, b1, b2} >>> (8 * 48)) & 16777215) == (b14 >>> 8));



assign smatch[49] = ((({cwindow, b1, b2} >>> (8 * 49)) & 16777215) == (b14 >>> 8));



assign smatch[50] = ((({cwindow, b1, b2} >>> (8 * 50)) & 16777215) == (b14 >>> 8));



assign smatch[51] = ((({cwindow, b1, b2} >>> (8 * 51)) & 16777215) == (b14 >>> 8));



assign smatch[52] = ((({cwindow, b1, b2} >>> (8 * 52)) & 16777215) == (b14 >>> 8));



assign smatch[53] = ((({cwindow, b1, b2} >>> (8 * 53)) & 16777215) == (b14 >>> 8));



assign smatch[54] = ((({cwindow, b1, b2} >>> (8 * 54)) & 16777215) == (b14 >>> 8));



assign smatch[55] = ((({cwindow, b1, b2} >>> (8 * 55)) & 16777215) == (b14 >>> 8));



assign smatch[56] = ((({cwindow, b1, b2} >>> (8 * 56)) & 16777215) == (b14 >>> 8));



assign smatch[57] = ((({cwindow, b1, b2} >>> (8 * 57)) & 16777215) == (b14 >>> 8));



assign smatch[58] = ((({cwindow, b1, b2} >>> (8 * 58)) & 16777215) == (b14 >>> 8));



assign smatch[59] = ((({cwindow, b1, b2} >>> (8 * 59)) & 16777215) == (b14 >>> 8));



assign smatch[60] = ((({cwindow, b1, b2} >>> (8 * 60)) & 16777215) == (b14 >>> 8));



assign smatch[61] = ((({cwindow, b1, b2} >>> (8 * 61)) & 16777215) == (b14 >>> 8));



assign smatch[62] = ((({cwindow, b1, b2} >>> (8 * 62)) & 16777215) == (b14 >>> 8));



assign smatch[63] = ((({cwindow, b1, b2} >>> (8 * 63)) & 16777215) == (b14 >>> 8));
