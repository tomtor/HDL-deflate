...
function integer MYHDL20_rev_bits;
    input [24-1:0] b;
    input nb;
    integer nb;
    integer r;
...
begin: MYHDL137_RETURN
    ...
    MYHDL21_put = (($signed({1'b0, ob1}) | (d << $signed({1'b0, doo}))) & 255);
...
begin: MYHDL141_RETURN
    ...
    MYHDL27_put = (($signed({1'b0, ob1}) | (d << $signed({1'b0, doo}))) & 255);
    disable MYHDL141_RETURN;
end
endfunction

task MYHDL28_put_adv;
    input d;
    integer d;
    input [4-1:0] width;
    reg pshift;
...
function integer MYHDL47_get4;
    input boffset;
    input width;
    integer width;
begin: MYHDL153_RETURN
    MYHDL47_get4 = ((b41 >>> (dio + boffset)) & ((1 << width) - 1));
    disable MYHDL153_RETURN;
end
endfunction

function integer MYHDL48_get4;
    input boffset;
    input width;
    integer width;
begin: MYHDL154_RETURN
    MYHDL48_get4 = ((b41 >>> (dio + boffset)) & ((1 << width) - 1));
...
function integer MYHDL56_rev_bits;
    input [16-1:0] b;
    input [4-1:0] nb;
    integer r;
...
begin: MYHDL157_RETURN
    ...
    MYHDL57_makeLeaf = ((lcode << 4) | lbits);
    disable MYHDL157_RETURN;
end
endfunction

function integer MYHDL58_makeLeaf;
    input [9-1:0] lcode;
    input [4-1:0] lbits;
begin: MYHDL158_RETURN
    ...
    MYHDL58_makeLeaf = ((lcode << 4) | lbits);
    disable MYHDL158_RETURN;
end
endfunction

function integer MYHDL59_makeLeaf;
    input [9-1:0] lcode;
    input [4-1:0] lbits;
begin: MYHDL159_RETURN
    ...
    MYHDL59_makeLeaf = ((lcode << 4) | lbits);
...
begin: MYHDL160_RETURN
    MYHDL60_get4 = ((b41 >>> (dio + boffset)) & ((1 << width) - 1));
...
begin: MYHDL170_RETURN
    MYHDL70_get_bits = ($signed({1'b0, aleaf}) & ((1 << 4) - 1));
...
function integer MYHDL72_get_code;
    input [19-1:0] aleaf;
begin: MYHDL172_RETURN
    MYHDL72_get_code = (aleaf >>> 4);
    disable MYHDL172_RETURN;
end
endfunction

function integer MYHDL73_get_bits;
    input [19-1:0] aleaf;
begin: MYHDL173_RETURN
    MYHDL73_get_bits = ($signed({1'b0, aleaf}) & ((1 << 4) - 1));
    disable MYHDL173_RETURN;
end
endfunction
...
function integer MYHDL75_get_bits;
    input [19-1:0] aleaf;
begin: MYHDL175_RETURN
    MYHDL75_get_bits = ($signed({1'b0, aleaf}) & ((1 << 4) - 1));
    disable MYHDL175_RETURN;
end
endfunction
...
function integer MYHDL78_get4;
    input boffset;
    integer boffset;
    input width;
    integer width;
begin: MYHDL178_RETURN
    MYHDL78_get4 = ($signed($signed({1'b0, b41}) >>> ($signed({1'b0, dio}) + boffset)) & ((1 << width) - 1));
    disable MYHDL178_RETURN;
end
endfunction

function integer MYHDL79_rev_bits;
    input b;
    integer b;
    input nb;
    integer nb;
...
begin: MYHDL179_RETURN
    ...
    r = r >>> (15 - $signed({1'b0, nb}));
    MYHDL79_rev_bits = r;
    disable MYHDL179_RETURN;
end
endfunction

function integer MYHDL80_get4;
    input boffset;
    integer boffset;
    input width;
    integer width;
begin: MYHDL180_RETURN
    MYHDL80_get4 = ($signed($signed({1'b0, b41}) >>> ($signed({1'b0, dio}) + boffset)) & ((1 << width) - 1));
        ...
        case (state)
            ...
            5'b11001: begin
                if ((!1'b1)) begin
                    ...
                    oaddr <= do;
                    obyte <= MYHDL18_put(outcarry, outcarrybits);
                    MYHDL19_put_adv(outcarry, outcarrybits);
                    ...
                    if ((nextdist > cur_dist)) begin
                        ...
                        outcode = (MYHDL20_rev_bits(cur_i, 5) | (extra_dist << 5));
                        oaddr <= do;
                        if ((extra_bits <= 4)) begin
                            obyte <= MYHDL21_put(outcode, (5 + extra_bits));
                            MYHDL22_put_adv(outcode, (5 + extra_bits));
                            cur_i <= (($signed({1'b0, di}) - $signed({1'b0, length})) + 1);
                            state <= 5'b11010;
                        end
                        else begin
                            ...
                            outcode = (outcode & 255);
                            obyte <= MYHDL23_put(outcode, 8);
                            MYHDL24_put_adv(outcode, 8);
                        end
                    end
                    else begin
                        cur_i <= (cur_i + 1);
                    ...
                    if (((cur_search >= 0) && (cur_search >= ($signed({1'b0, di}) - 32)) && ($signed({1'b0, di}) < ($signed({1'b0, isize}) - 3)))) begin
                        if (1'b1) begin
                            ...
                            if ((($signed({1'b0, di}) < ($signed({1'b0, isize}) - 4)) && (iram[((cur_search + 3) & 63)] == b4))) begin
                                ...
                                else if ((($signed({1'b0, di}) < ($signed({1'b0, isize}) - 5)) && (iram[((cur_search + 4) & 63)] == b5))) begin
                                    lencode = 259;
                                    match = 5;
                                    if (1'b1) begin
                                        if ((fcount < 10)) begin
                                        ...
                                        else if ((($signed({1'b0, di}) < ($signed({1'b0, isize}) - 6)) && (iram[((cur_search + 5) & 63)] == b6))) begin
                                            lencode = 260;
                                            match = 6;
                        ...
                        endcase
                        oaddr <= do;
                        obyte <= MYHDL27_put(outbits, outlen);
                        MYHDL28_put_adv(outbits, outlen);
                        state <= 5'b10110;
                    end
                end
            end
            ...
            5'b00010: begin
                if (((!1'b0) || (!1'b1))) begin
                    ...
                    $write("%h", isize);
                    $write("\n");
                    numLiterals <= (257 + MYHDL37_get4(0, 5));
                    $write("NL:");
                    $write(" ");
                    $write("%0d", (257 + MYHDL38_get4(0, 5)));
                    $write("\n");
                    numDistance <= (1 + MYHDL39_get4(5, 5));
                    $write("ND:");
                    $write(" ");
                    $write("%0d", (1 + MYHDL40_get4(5, 5)));
                    $write("\n");
                    b_numCodeLength <= (4 + MYHDL41_get4(10, 4));
                    $write("NCL:");
                    $write(" ");
                    $write("%0d", (4 + MYHDL42_get4(10, 4)));
                    $write("\n");
                    numCodeLength <= 0;
                    MYHDL43_adv(14);
                end
                    ...
                    if ((numCodeLength < 19)) begin
                        ...
                        if ((numCodeLength < b_numCodeLength)) begin
                            codeLength[clo_i] <= MYHDL44_get4(0, 3);
                            MYHDL45_adv(3);
                        end
                        else begin
                            codeLength[clo_i] <= 0;
            ...
            5'b00011: begin
                if (((!1'b0) || (!1'b1))) begin
                    ...
                    if ((code < 16)) begin
                        ...
                        howOften <= (3 + MYHDL46_get4(0, 2));
                        n_adv = 2;
                    end
                    else if ((code == 17)) begin
                        howOften <= (3 + MYHDL47_get4(0, 3));
                        lastToken <= 0;
                        n_adv = 3;
                    end
                    else if ((code == 18)) begin
                        howOften <= (11 + MYHDL48_get4(0, 7));
                        lastToken <= 0;
                        n_adv = 7;
                    end
                    else begin
            ...
            5'b00111: begin
                if (1'b0) begin
                    ...
                    if (((cur_HF1 < 1) && 1'b1)) begin
                        dlwaddr <= cur_HF1;
                        dwleaf <= 0;
                    end
                    if (((method != 4) && (cur_HF1 < 1))) begin
                        lwaddr <= cur_HF1;
                        wleaf <= 0;
                    end
                    limit = 1;
            ...
            5'b01100: begin
                if (1'b0) begin
                    ...
                    reverse <= MYHDL56_rev_bits(canonical, bits);
                    leaf <= MYHDL57_makeLeaf(spread_i, bits);
                    state <= 5'b01101;
                end
            end
            5'b01101: begin
            ...
            5'b10010: begin
                if (1'b0) begin
                    if (((method == 4) && 1'b1)) begin
                        dlwaddr <= spread;
                        dwleaf <= MYHDL58_makeLeaf(spread_i, codeLength[spread_i]);
                    end
                    else begin
                        lwaddr <= spread;
                        wleaf <= MYHDL59_makeLeaf(spread_i, codeLength[spread_i]);
                    end
                    aim = instantMask;
                    if (((method == 4) && 1'b1)) begin
                        aim = d_instantMask;
            ...
            5'b10011: begin
                if ((!1'b0)) begin
                    ...
                    cto = MYHDL60_get4(0, maxBits);
                    mask = ((1 << instantMaxBit) - 1);
                    lraddr <= (cto & mask);
                    filled <= 1'b0;
                    cur_next <= (instantMaxBit + 1);
                end
                else if ((MYHDL61_get_bits(rleaf) >= cur_next)) begin
                    $write("CACHE MISS");
                    $write(" ");
                    $write("%h", cur_next);
                    $write("\n");
                    cto = MYHDL62_get4(0, maxBits);
                    mask = ((1 << cur_next) - 1);
                    lraddr <= (cto & mask);
                    filled <= 1'b0;
                    cur_next <= (cur_next + 1);
                    ...
                    if ((MYHDL63_get_bits(rleaf) < 1)) begin
                        $write("< 1 bits: ");
                        $write("\n");
                        $finish;
                    end
                    MYHDL65_adv(MYHDL64_get_bits(rleaf));
                    // if get_code(leaf) == 0:
                    //     print("leaf 0", di, isize)
                    code <= MYHDL66_get_code(rleaf);
            ...
            5'b01111: begin
                if (((!1'b0) || (!1'b1))) begin
                    ...
                    endcase
                    cto = MYHDL67_get4(extraLength, d_maxBits);
                    mask = ((1 << d_instantMaxBit) - 1);
                    dlraddr <= (cto & mask);
                    filled <= 1'b0;
                    cur_next <= (instantMaxBit + 1);
                end
                else if ((MYHDL68_get_bits(drleaf) >= cur_next)) begin
                    $write("DCACHE MISS");
                    $write(" ");
                    $write("%h", cur_next);
                    $write("\n");
                    ...
                    case (token)
                        ...
                        default: extraLength = 0;
                    endcase
                    cto = MYHDL69_get4(extraLength, d_maxBits);
                    mask = ((1 << cur_next) - 1);
                    dlraddr <= (cto & mask);
                    filled <= 1'b0;
                    cur_next <= (cur_next + 1);
            ...
            5'b10000: begin
                if ((1'b0 && 1'b1)) begin
                    if ((MYHDL70_get_bits(drleaf) == 0)) begin
                        $finish;
                    end
                    token = (code - 257);
                    case (token)
                    ...
                    distanceCode = MYHDL72_get_code(drleaf);
                    case (distanceCode)
                        0: distance = 1;
                        1: distance = 2;
                        2: distance = 3;
                    ...
                    case ($signed(distanceCode >>> 1))
                        ...
                        default: moreBits = 13;
                    endcase
                    mored = MYHDL74_get4((extraLength + MYHDL73_get_bits(drleaf)), moreBits);
                    ...
                    MYHDL76_adv(((moreBits + extraLength) + MYHDL75_get_bits(drleaf)));
                    ...
                    if ((code < 256)) begin
                        ...
                        if (static) begin
                            ...
                            case (token)
                                ...
                                default: extraLength = 0;
                            endcase
                            tlength = tlength + MYHDL77_get4(0, extraLength);
                            t = MYHDL78_get4(extraLength, 5);
                            distanceCode = MYHDL79_rev_bits(t, 5);
                            case (distanceCode)
                                0: distance = 1;
                                1: distance = 2;
                                2: distance = 3;
                            ...
                            case ($signed(distanceCode >>> 1))
                                ...
                                default: moreBits = 13;
                            endcase
                            distance = distance + MYHDL80_get4((extraLength + 5), moreBits);
                            MYHDL81_adv(((extraLength + 5) + moreBits));
